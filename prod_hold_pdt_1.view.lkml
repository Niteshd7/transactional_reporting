view: prod_hold_pdt_1 {
  derived_table: {
    sql: SELECT  * FROM (  SELECT
        ...
        CONCAT('$',
           FORMAT(SUM(hold_rev), 2), '')          AS hold_rev_fmt,
    ...
    FROM
        (
           SELECT
                 ...
                 SUM(hold_rev + hold_rev_o)           AS hold_rev,
                          ...
                          (
                             SELECT
                              ...
                              WHERE
                                ...
                                AND
                                   (
                                      (o.t_stamp BETWEEN (SELECT ({% date_start orders.t_stamp_date %})) AND (SELECT ({% date_end orders.t_stamp_date %})))
                                        OR
                                                   (o.hold_date BETWEEN (SELECT ({% date_start orders.t_stamp_date %})) AND (SELECT ({% date_end orders.t_stamp_date %})))
                                   )
                                   AND o.is_test_cc IN (0, 1)
                          ...
                          UNION ALL
                             SELECT
                              ...
                              WHERE
                                ...
                                AND
                                   (
                                      (uo.t_stamp BETWEEN (SELECT ({% date_start orders.t_stamp_date %})) AND (SELECT ({% date_end orders.t_stamp_date %})))
                                        OR
                                                   (uo.hold_date BETWEEN (SELECT ({% date_start orders.t_stamp_date %})) AND (SELECT ({% date_end orders.t_stamp_date %})))
                                   )
                                   AND o.is_test_cc IN (0, 1)
