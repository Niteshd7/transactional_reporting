        ...
        (
           SELECT
                 ...
                 CASE 'DATE'
                    ...
                    WHEN 'C2'    THEN o.C3
                    WHEN 'DATE'  THEN
                       IF(o.hold_date BETWEEN '2017-03-28 00:00:00' AND '2017-03-28 23:59:59' AND NOT o.t_stamp BETWEEN '2017-03-28 00:00:00' AND '2017-03-28 23:59:59',
                          DATE(o.hold_date),
                          DATE(o.t_stamp)
                       )
                 ...
                 (
                    SELECT
                      ...
                      WHERE
                        ...
                        AND
                           o.t_stamp BETWEEN '2017-03-28 00:00:00' AND '2017-03-28 23:59:59'
                       ...
                       FROM
                           ...
                           (
                              SELECT
                                    ...
                                    IF((hold_date BETWEEN '2017-03-28 00:00:00' AND '2017-03-28 23:59:59') AND (t_stamp NOT BETWEEN '2017-03-28 00:00:00' AND '2017-03-28 23:59:59'), 1, 0) AS outside
                                FROM
                                    orders o
                               WHERE
                                    o.is_hold = 1
                           ...
                           UNION ALL
                              SELECT
                                    ...
                                    IF((uo.hold_date BETWEEN '2017-03-28 00:00:00' AND '2017-03-28 23:59:59') AND (uo.t_stamp NOT BETWEEN '2017-03-28 00:00:00' AND '2017-03-28 23:59:59'), 1, 0) AS outside
                                FROM
                                    orders        o,
                                    upsell_orders uo
                               WHERE
                                 ...
                                 AND
                                    (
                                       uo.t_stamp   BETWEEN '2017-03-28 00:00:00' AND '2017-03-28 23:59:59'
